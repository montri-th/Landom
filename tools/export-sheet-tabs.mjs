...
const readmeRows = [
  ...
  { topic: 'bio', detail: 'ครบ 52 profiles: 26 ข้อความ paraphrase จาก first-person ที่จับคู่ roster ได้ exact และ 26 factual fallback ที่สังเคราะห์แบบ bounded จาก role, education และ verified work เท่านั้น โดยคงข้อความเดิม 51 คนไว้และเพิ่มข้อความสำหรับผู้สมัครปี 2026 ที่จับคู่ตัวตนได้ exact อีก 1 คน ทุกข้อความเป็น source_backed_placeholder และรอ candidate/video review; ห้ามเผย raw application, private recruitment/application Sheet ID/range, contact หรือ reviewer data' },
