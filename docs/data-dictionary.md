...
release นี้แก้เฉพาะพื้นขาวไร้ context ของ `I0001`, `I0008`, `I0012`, `I0018`, `I0019`, `I0021`, `I0025`, `I0033` และ `I0035` โดย composite approved DS gradient ผ่าน pixel-preserving foreground mask และไม่แก้ portrait ที่มีบรรยากาศอยู่แล้ว ต้องใช้ approved recipe หลายแบบ บันทึก recipe ที่ใช้ไว้ต่อ asset และใช้ Diversity Spectrum กับ portrait เดียวเท่านั้น edge-refined v2 ปรับได้เฉพาะ transition ตรงขอบ mask เพื่อลดขอบขาว โดยต้องคง crop, portrait interior, gradient token/CSS, identity, rights และ publication basis เดิม; ความต่างภายในหลังบันทึก JPEG ให้นับเป็นผลจาก re-encoding ไม่ใช่การ retouch หลังแทนภาพต้อง sync SHA-256/bytes ใน public projection/manifest กับ canonical Sheet tab `assets` คอลัมน์ R:T (`sha256`, `media_type`, `bytes`) ไม่มี Drive portrait mirror จึงห้ามสร้างหรืออัปโหลดไฟล์ซ้ำไป Google Drive
