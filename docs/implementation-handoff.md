...
| `public/` | `dist/public/` | Approved, repository-owned assets, including exact motif runtime and SVG fallbacks |
...
The page keeps the owner-approved static horizontal Landometer lockup and the established favicon/social-image role boundaries. Motif release `1.2.1`, family `landometer.motif.v3`, supplies separately governed animated decoration and exact final-state fallbacks; it does not replace those identity roles. Photo parallax remains an explicit owner-directed Landom behavior even though Design System 0.9.1 prohibits it. Because v0.9.1 has no artifact exception channel, the released page must not claim zero-exception v0.9.1 conformance while parallax remains enabled. This declaration does not relax any other applicable resolved rule.
...
| `<lm-motif>` and exact child fallback `<img>` | Motif 1.2.1 progressive-enhancement surface; complete final state exists before runtime upgrade |
...
Motif release `1.2.1` uses exact local runtime bytes at `public/assets/landometer/landometer-motifs.css` (SHA-256 `7cc2deb475a8d6e4af331407b2b4b741716c458a8ce885e2fb2859374b93912e`) and `public/assets/landometer/landometer-motifs.js` (SHA-256 `3a5caef7918a85885b61dd53e049ea8bf2b0a3cea508f587bb14970bfe6deaf2`). All six role-scoped animated surfaces select the exact quiet record:

| Release asset | Page role | Local fallback | Bytes | SHA-256 |
|---|---|---|---:|---|
...
| `landometer.rings.quiet` | Hero spatial depth | `public/assets/landometer/svg/rings-quiet.svg` | 833 | `d494be1f72e833704cd3c20d9d41f60599991d6efd5f670a86e40a7296eb566b` |
| `landometer.dial.quiet` | Directory opener | `public/assets/landometer/svg/dial-quiet.svg` | 733 | `2e624d80b604891ad2ed3e4d5cc6268d2383f39f740ef1def5012c49aee0da1f` |
| `landometer.layers.quiet` | Profile/detail hover decoration | `public/assets/landometer/svg/layers-quiet.svg` | 1,274 | `e3e2bf65bcd38d34d0a07910bef44917eab76fdaf097131ec133d163f6a65a03` |
| `landometer.slice.quiet` | Action/map hover decoration | `public/assets/landometer/svg/slice-quiet.svg` | 350 | `c72114d43b81584cbb46251a5519f768087259bf135216f6ea7933a83df4de6b` |
...
- all six motif surfaces and fallbacks at 320, 360, 390, tablet, and wide desktop widths, both themes, 130% and 200% text scale, no JavaScript, print, runtime failure, pause/resume, offscreen exit, visibility changes, and BFCache; inspect at least two replay cycles and verify no timer/DOM/request accumulation;
