...
import { clamp, parallaxOffset } from "../src/media-parallax.js";
...
test("parallax depth is capped at 24px and malformed geometry is static", () => {
...
test("runtime contract is explicit, passive, gated, lifecycle-safe, and non-intercepting", () => {
  ...
  assert.match(source, /MAX_DEPTH = 24/);
